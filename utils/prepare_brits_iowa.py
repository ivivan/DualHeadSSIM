...
def preprocess_df(df):
    ...
    scaler_x.fit(do['diss_oxy_con'].values.reshape(-1, 1))
    do['diss_oxy_con'] = scaler_x.transform(do['diss_oxy_con'].values.reshape(
        -1, 1))

    # get data from 2014 and 2015
    # 6，7, 8, 9，10 as train; 11 as test

    # df_2014 = do.loc['2014-06-01T00:00':'2014-11-30T23:30'].copy()
    # df_2015 = do.loc['2015-06-01T00:00':'2015-11-30T23:30'].copy()

    df_train_one = do.loc['2014-06-01T00:00':'2014-10-31T23:30'].copy()
    df_train_two = do.loc['2015-06-01T00:00':'2015-10-31T23:30'].copy()
    # df_train_three = do.loc['2015-06-01T00:00':'2015-07-31T23:30'].copy()
    # df_train_four = do.loc['2015-08-01T00:00':'2015-10-31T23:30'].copy()
    df_test_one = do.loc['2014-11-01T00:00':'2014-11-30T23:30'].copy()
    df_test_two = do.loc['2015-11-01T00:00':'2015-11-30T23:30'].copy()
    # df_test_three = do.loc['2015-08-01T00:00':'2015-08-31T23:30'].copy()
    # df_test_four = do.loc['2015-11-01T00:00':'2015-11-30T23:30'].copy()

    # return df_train_one, df_train_two, df_train_three, df_train_four, df_test_one, df_test_two, df_test_three, df_test_four, scaler_x
...
def train_val_test_generate(dataframe, model_params):
    ...
    train_val_test_x, train_val_test_y, len_x_samples, len_before_x_samples = pad_all_cases(
        dataframe, dataframe['diss_oxy_con'].values, model_params,
...
if __name__ == "__main__":
    ...
    x_train = np.concatenate(
        (x_train_one, x_train_two), axis=0)
    y_train = np.concatenate(
        (y_train_one, y_train_two), axis=0)
    ...
    x_test = np.concatenate(
        (x_test_one, x_test_two), axis=0)
    y_test = np.concatenate(
        (y_test_one, y_test_two), axis=0)
    ...
    with open('DO_train.json', 'w') as fp:
        fp.write('\n'.join(json.dumps(i) for i in sample_list_train))
    with open('DO_test.json', 'w') as fp:
